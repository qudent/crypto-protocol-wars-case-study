...
This is not purely speculative. Two real-world systems illustrate what an OSI-style internet would have looked like. France's **Minitel** (1978-2012) was a centralized, state-operated data network run by France Télécom: all services were hosted by the carrier, users were identified and billed per-minute, and launching a new service required approval from the operator. Minitel was commercially successful within France but was a walled garden that produced no equivalents of the World Wide Web, open-source software, or peer-to-peer communication. China's **Great Firewall** demonstrates that it is entirely possible to build a network that violates the end-to-end principle through deep packet inspection and centralized routing, giving the state comprehensive control over what its citizens can access and publish. The open internet is not a law of nature; it is the product of specific architectural choices that were contested and could have gone the other way.
